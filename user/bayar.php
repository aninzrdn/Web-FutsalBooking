...
$sewa = query("SELECT sewa.*, lapangan.nama, bayar.bukti, bayar.konfirmasi
FROM sewa
JOIN lapangan ON sewa.id_lapangan = lapangan.id_lapangan
left JOIN bayar ON sewa.id_sewa = bayar.id_sewa
WHERE sewa.id_user = '$id_user' LIMIT $awalData, $jmlHalamanPerData");
// Pagination
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          if (isset($_SESSION['id_user'])) {
            ...
            echo '<a href="" data-bs-toggle="modal" data-bs-target="#profilModal" class="btn" style="background-color: #6A5ACD;"><i data-feather="user"></i></a>';
          } else {
              ...
              <div class="col">
                ...
                <div class="mb-3">
                  ...
                  <select class="form-control" id="jenis_kelamin" name="jenis_kelamin" required>
                    <option value="Laki-laki" <?php if ($profil['jenis_kelamin'] == 'Laki-laki')
                                                echo 'selected'; ?>>Laki-laki</option>
                    <option value="Perempuan" <?php if ($profil['jenis_kelamin'] == 'Perempuan')
              ...
              <tr>
                ...
                <td>
                  ...
                  if ($row["konfirmasi"] == "Sudah Bayar" || $row["konfirmasi"] == "Terkonfirmasi") {
                    echo '<button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#detailModal' . $row["id_sewa"] . '">Detail</button> ';
                  } else {
                    echo '<button type="button" class="btn btn-inti" data-bs-toggle="modal" data-bs-target="#bayarModal' . $row["id_sewa"] . '">Bayar</button>
<a href="" data-bs-toggle="modal" data-bs-target="#hapusModal' . $row["id_sewa"] . '" class="btn btn-danger">Hapus</a>';
                  }
                  ?>
                            ...
                            <div class="row justify-content-center align-items-center">
                              ...
                              <div class="col">
                                <div class="mb-3">
                                  ...
                                  <input type="text" name="jam_mulai" class="form-control" id="exampleInputPassword1" value="<?= $row["lama_sewa"]; ?>" disabled>
                                </div>
                                <div class="mb-3">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="row justify-content-center align-items-center">
                              ...
                              <div class="col">
                                <div class="mb-3">
                                  <label for="exampleInputPassword1" class="form-label">Lama Main</label>
                                  <input type="time" name="jam_mulai" class="form-control" id="exampleInputPassword1" value="<?= $row["lama_sewa"]; ?>" disabled>
                                </div>
                                <div class="mb-3">
                                  <label for="exampleInputPassword1" class="form-label">Harga</label>
                                  <input type="number" name="harga" class="form-control" id="exampleInputPassword1" value="<?= $row["harga"]; ?>" disabled>
