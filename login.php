...
<body class="login" style="background-image: url('img/bg2.png');">
  <div class="center">
    <h1 style="color: #6A5ACD;">Login</h1>
    <form method="POST">
      <div class="txt_field">
        <input type="email" name="username" required>
        <span></span>
        <label style="color: #6A5ACD;">Email</label>
      </div>
      <div class="txt_field">
        <input type="password" name="password" required>
        <span></span>
        <label style="color: #6A5ACD;">Password</label>
      </div>
