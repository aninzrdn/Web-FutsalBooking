    ...
    <div class="row min-vh-100">
      <div class="sidebar col-2 bg-secondary">
        ...
        <h5 class="mt-5 judul text-center">
          <h5 style="color: #FFFFFF;" class="mt-5 judul text-center">
            <?= $_SESSION["username"]; ?>
          </h5>
        </h5>
      ...
      <div class="col-10 p-5 mt-5">
        <!-- Konten -->
        <h3 style="color: #6A5ACD;" class="judul">Data Lapangan</h3>
        <hr>
        <button class="btn btn-tambah mt-5" style="color: #FFFFFF" data-bs-toggle="modal" data-bs-target="#tambahModal1">Tambah</button>
        <!-- Modal Tambah -->
          ...
          <tbody class="text">
            ...
            <?php foreach ($lapangan as $row): ?>
              <tr>
                ...
                <td>
                  <button class="btn btn-inti btn-edit" data-bs-toggle="modal"
                    data-bs-target="#editModal<?= $row["id_lapangan"]; ?>">Edit</button>
                  <a href="./controller/hapusLpg.php?id=<?= $row["id_lapangan"]; ?>"
                ...
                <div class="modal fade" id="editModal<?= $row["id_lapangan"]; ?>" tabindex="-1"
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="tambahModalLabel">Edit Lapangan
                          <?= $row["nama"]; ?>
                        </h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <form action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="idlap" class="form-control" id="exampleInputPassword1"
                          value="<?= $row["id_lapangan"]; ?>">
                        <input type="hidden" name="fotoLama" class="form-control" id="exampleInputPassword1"
                          value="<?= $row["foto"]; ?>">
                        <div class="modal-body">
                          <!-- konten form modal -->
                          <div class="row justify-content-center align-items-center">
