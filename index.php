...
if(isset(query("SELECT * FROM user WHERE id_user = '$id_user'")[0])){
...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            <li class="nav-item ">
              <a class="nav-link active" aria-current="page" href="#home" class="btn" style="background-color: #6A5ACD;" >Home</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#about" class="btn" style="background-color: #6A5ACD;" >About</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#bayar" class="btn" style="background-color: #6A5ACD;" >Tata Cara</a>
            </li>
            <?php
            if (isset($_SESSION['id_user'])) {
              echo '
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="user/lapangan.php" class="btn" style="background-color: #6A5ACD;">Lapangan</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="user/bayar.php" class="btn" style="background-color: #6A5ACD;" >Pembayaran</a>
            </li>
            ';
            }
            ?>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#contact" class="btn" style="background-color: #6A5ACD;" >Kontak</a>
            </li>
          </ul>
          <?php
          if (isset($_SESSION['id_user'])) {
            ...
            echo '<a href="login.php" class="btn" style="background-color: #6A5ACD; type="submit">Login</a>';
          }
          ?>
        </div>
      </div>
  ...
  <!-- Jumbotron -->
  <section class="jumbotron" id="home" style="background-image: url('img/bg1.png');">
    <main class="contain" data-aos="fade-right" data-aos-duration="1000">
    <h1 class="text-light">Canda dan Ceria di Lapangan <span style="color: #6A5ACD;">Futsal Booking</span></h1>
      <p>
        Berolahraga sambil ketawa-ketiwi
      </p>
      <a href="user/lapangan.php" class="btn" style="background-color: #6A5ACD; color: white;">Tancap Gas Booking</a>
    </main>
  </section>
  <!-- End Jumbotron -->
  ...
  <section class="about" id="about">
    <h2 data-aos="fade-down" data-aos-duration="1000">
      <span style="color: #6A5ACD;">Tentang</span> Kami
    </h2>
    <div class="row">
      <div class="about-img" data-aos="fade-right" data-aos-duration="1000">
        <img src="img/bg1,1.jpg" alt="" />
      </div>
      <div class="contain" data-aos="fade-left" data-aos-duration="1000">
        <h4 class="text-center mb-3">Kenapa Memilih kami?</h4>
        <p>Futsal Booking adalah pusat olahraga yang menyediakan berbagai fasilitas dan layanan penyewaan lapangan untuk jenis olahraga futsal. Tempat ini dirancang untuk memfasilitasi kegiatan olahraga dan rekreasi bagi individu, kelompok, dan komunitas yang memiliki minat dalam berpartisipasi dalam aktivitas fisik. Futsal Booking menawarkan jenis lapangan yang dapat disewa untuk jenis olahraga, seperti futsal. Setiap lapangan dilengkapi dengan fasilitas yang sesuai, termasuk garis-garis permainan, jaring, dan peralatan yang dibutuhkan untuk menjalankan aktivitas olahraga dengan lancar.</p>
      </div>
    </div>
  </section>
  <!-- End About -->
  ...
  <section class="pembayaran" id="bayar">
    <h2 data-aos="fade-down" data-aos-duration="1000">
      <span style="color: #6A5ACD;">Tata Cara</span> Pembayaran
    </h2>
    <p class="text-center">Berikut adalah tata cara pembayaran lapangan pada website Futsal Booking:</p>
    <ul class="border list-group list-group-flush mt-5">
      <li class="list-group-item">1. Pengguna harus membuat akun atau mendaftar sebagai anggota pada website Futsal Booking.</li>
      ...
      <li class="list-group-item">8. Setelah status sudah di setujui, silahkan datang ke Futsal Booking sesuai jadwal yang di pesan</li>
    </ul>
  </section>
  <!-- End Pembayaran -->
  ...
  <section id="contact" class="contact" data-aos="fade-down" data-aos-duration="1000">
    <h2><span style="color: #6A5ACD;">Kontak</span> Kami</h2>
    <p class="text-center m-5">
      Sarankan sesuatu yang bikin kami tersenyum lebar
    </p>
    <div class="row">
      <!-- <div class="col">
      ...
      <div class="col">
        <form action="">
          <a href="http://wa.me/+62882010017358" type="submit" class="btn" style="background-color: #6A5ACD;">Kirim Pesan</a>
        </form>
      </div>
    </div>
  </section>
